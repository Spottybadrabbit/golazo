...
/**
 * Account control. With Clerk configured it drives real sign-in through the
 * modal, which surfaces the enabled Solana wallet strategy (on-brand for the
 * TxODDS rails) alongside email, and shows the account menu once in. Without
 * keys it degrades to the demo wallet chip so the game still runs.
 */
